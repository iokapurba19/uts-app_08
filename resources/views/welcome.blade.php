                ...
                <div class="flex space-x-4 overflow-x-auto">
                    ...
                    <div class="bg-white p-4 border border-gray-300 shadow-sm">
                        ...
                        <ul class="list-none p-0 m-0">
                            <li class="mb-2"><a href="https://www.youtube.com/watch?v=video1"
                                    class="text-blue-600 hover:text-blue-800">Video 1</a></li>
                            <li class="mb-2"><a href="https://www.youtube.com/watch?v=video2"
